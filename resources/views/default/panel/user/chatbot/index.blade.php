...
@section('titlebar_actions')
    <div class="space-x-1.5">
        <x-button
            ...
            href="{{ $app_is_demo ? '#' : LaravelLocalization::localizeUrl(route('dashboard.user.chatbot.create')) }}"
        >
            {{ __('Add New Chatbot') }}
        </x-button>
    </div>
            ...
            <x-slot:body>
                @foreach ($items as $item)
                    <tr>
                        ...
                        <td>
                            @include('panel.user.chatbot.status', ['status' => $item->status])
                        </td>
                        <td>
                        ...
                        <td class="text-end">
                            <x-button
                                ...
                                size="none"
                                href="{{ route('dashboard.user.chatbot.show', $item->id) }}"
                            ...
                            <x-button
                                ...
                                size="none"
                                onclick="deleteChatbot('{{ route('dashboard.user.chatbot.destroy', $item->id) }}')"
                                title="{{ __('Delete') }}"
                            >
