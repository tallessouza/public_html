...
@section('settings')
    ...
    <p class="mb-9 font-medium">
        @lang('Basta selecionar a fonte e o Lab[IA] fará todo o processo para treinar o seu GPT.')
    </p>
    ...
    <div x-data="{
        ...
        <div>
            @include('panel.user.chatbot.particles.web-site-tab')
            @include('panel.user.chatbot.particles.pdf-tab')
            @include('panel.user.chatbot.particles.text-tab')
            @include('panel.user.chatbot.particles.qa-tab')
        </div>
    </div>
            ...
            <div class="flex min-h-screen flex-col items-center justify-center py-7">
                <div class="flex w-full flex-col items-center gap-11 md:w-5/12 lg:w-3/12">
                    ...
                    <div class="space-y-3">
                        ...
                        <p>
                            @lang('Estamos treinando seu GPT com os recursos informados. Este processo pode levar alguns minutos para ser concluído.')
                        </p>
                    </div>
                </div>
            </div>
