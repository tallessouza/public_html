<div :class="{ 'hidden': activeTab !== 'website' }">
    ...
    >
        ...
        <div class="relative">
            ...
            <x-button
                ...
                data-action="{{ route('dashboard.user.chatbot.web-sites', $item) }}"
                variant="link"
                size="none"
                type="button"
            >
    ...
    <form
        ...
        action="{{ route('dashboard.user.chatbot.training', $item->id) }}"
    >
        @csrf
        <input
            id="type"
        ...
        <div
            ...
            id="pages"
        >
            @include('panel.user.chatbot.particles.web-site.crawler', ['items' => $websites])
        </div>
    </form>
</div>
