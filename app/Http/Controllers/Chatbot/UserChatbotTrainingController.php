...
class UserChatbotTrainingController extends Controller
{
    ...
    public function training(
        ...
        $matchView = match ($type) {
            'url' => 'panel.user.chatbot.particles.web-site.crawler',
            'pdf' => 'panel.user.chatbot.particles.pdf.list',
            'text' => 'panel.user.chatbot.particles.text.list',
            'qa' => 'panel.user.chatbot.particles.qa.list',
        };
