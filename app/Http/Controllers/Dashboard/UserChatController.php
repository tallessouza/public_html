...
class UserChatController extends Controller
{
    public function index()
    {
        ...
        return view('panel.user.index', compact('activity', 'latestOrders', 'gatewayError'));
    }
    ...
    public function users(Request $request)
    {
        ...
        return view('panel.user.users.index', compact('users'));
    }
    ...
    public function usersSearch(Request $request)
    {
        ...
        return view('panel.user.users.components.users-table', compact('users'));
    }
    ...
    public function freeFeature(Request $request)
    {
        ...
        return view('panel.user.finance.free-feature', compact('openAiList', 'selectedAiList'));
    }
    ...
    {
        return view('panel.user.users.edit', compact('user'));
    }
    ...
    public function usersFinance($id)
    {
        ...
        return view('panel.user.users.finance', compact('user'));
    }

    public function usersAdd()
    {
        return view('panel.user.users.create');
    }
    ...
    public function openAIList()
    {
        ...
        return view('panel.user.openai.list', compact('list'));
    }
    ...
    public function categoryList(Request $request)
    {
        ...
        return view('panel.user.openai.chat.category', compact('list'));
    }
    ...
    public function addOrUpdateCategory($id = null)
    {
        ...
        return view('panel.user.openai.chat.category.template', compact('item'));
    }
    ...
    public function openAIChatList()
    {
        ...
        return view('panel.user.openai.chat.list', compact('list'));
    }
    ...
    public function openAICategoriesList()
    {
        ...
        return view('panel.user.openai.categories.list', compact('list'));
    }
    ...
    public function openAICategoriesAddOrUpdate($id = null)
    {
        ...
        return view('panel.user.openai.categories.form', compact('item'));
    }
    ...
    public function paymentPlans()
    {
        ...
        return view('panel.user.finance.plans.index', compact('plans', 'gatewayError', 'setting'));
    }
    ...
    public function paymentPlansSubscriptionNewOrEdit($id = null)
    {
        ...
        if ($id == null) {
            ...
            return view('panel.user.finance.plans.SubscriptionNewOrEdit', compact('isActiveGateway', 'openAiList', 'selectedAiList'));
        } else {
            $subscription = PaymentPlans::where('id', $id)->firstOrFail();

            $selectedAiList = $subscription->open_ai_items ?: [];

            return view('panel.user.finance.plans.SubscriptionNewOrEdit', compact('subscription', 'selectedAiList', 'isActiveGateway', 'generatedData', 'openAiList'));
        }
    }
    ...
    public function paymentPlansPrepaidNewOrEdit($id = null)
    {
        ...
        if ($id == null) {
            ...
            return view('panel.user.finance.plans.PrepaidNewOrEdit', compact('openAiList', 'selectedAiList', 'isActiveGateway'));
        } else {
            $subscription = PaymentPlans::where('id', $id)->first();
            $selectedAiList = $subscription->open_ai_items ?: [];

            return view('panel.user.finance.plans.PrepaidNewOrEdit', compact('openAiList', 'selectedAiList', 'subscription', 'isActiveGateway', 'generatedData'));
        }
    }
    ...
    public function testimonials()
    {
        ...
        return view('panel.user.testimonials.index', compact('testimonialList'));
    }

    public function testimonialsNewOrEdit($id = null)
    {
        if ($id == null) {
            return view('panel.user.testimonials.TestimonialNewOrEdit');
        } else {
            $testimonial = Testimonials::where('id', $id)->first();

            return view('panel.user.testimonials.TestimonialNewOrEdit', compact('testimonial'));
        }
    }
    ...
    public function howitWorks()
    {
        ...
        return view('panel.user.howitworks.index', compact('howitWorksList', 'defaults'));
    }

    public function howitWorksNewOrEdit($id = null)
    {
        if ($id == null) {
            return view('panel.user.howitworks.HowitWorksNewOrEdit');
        } else {
            $howitWorks = HowitWorks::where('id', $id)->first();

            return view('panel.user.howitworks.HowitWorksNewOrEdit', compact('howitWorks'));
        }
    }
    ...
    public function clients()
    {
        ...
        return view('panel.user.clients.index', compact('clientList'));
    }

    public function clientsNewOrEdit($id = null)
    {
        if ($id == null) {
            return view('panel.user.clients.ClientNewOrEdit');
        } else {
            $client = Clients::where('id', $id)->first();

            return view('panel.user.clients.ClientNewOrEdit', compact('client'));
        }
    }
    ...
    public function affiliatesList()
    {
        ...
        return view('panel.user.affiliate.index', compact('list', 'list2'));
    }
    ...
    public function couponsList()
    {
        ...
        return view('panel.user.coupons.index', compact('list'));
    }
    ...
    public function couponsListUsed($id)
    {
        ...
        return view('panel.user.coupons.used', compact('coupon'));
    }
    ...
    {
        return view('panel.user.frontend.settings');
    }
    ...
    {
        return view('panel.user.frontend.section_settings');
    }
    ...
    {
        return view('panel.user.frontend.menu');
    }
	...
	public function authSettings()
    {
        ...
        return view('panel.user.frontend.auth', compact('auth'));
    }
    ...
    public function frontendFaq()
    {
        ...
        return view('panel.user.frontend.faq.index', compact('faq'));
    }
    ...
    public function frontendFaqcreateOrUpdate($id = null)
    {
        ...
        return view('panel.user.frontend.faq.form', compact('faq'));
    }
    ...
    public function frontendTools()
    {
        ...
        return view('panel.user.frontend.tools.index', compact('items'));
    }
    ...
    public function frontendToolscreateOrUpdate($id = null)
    {
        ...
        return view('panel.user.frontend.tools.form', compact('item'));
    }
    ...
    public function frontendFuture()
    {
        ...
        return view('panel.user.frontend.future.index', compact('items'));
    }
    ...
    public function frontendFuturecreateOrUpdate($id = null)
    {
        ...
        return view('panel.user.frontend.future.form', compact('item'));
    }
    ...
    public function frontendWhois()
    {
        ...
        return view('panel.user.frontend.who_is_for.index', compact('items'));
    }
    ...
    public function frontendWhoiscreateOrUpdate($id = null)
    {
        ...
        return view('panel.user.frontend.who_is_for.form', compact('item'));
    }
    ...
    public function frontendGeneratorlist()
    {
        ...
        return view('panel.user.frontend.generators_list.index', compact('items'));
    }
    ...
    public function frontendGeneratorlistcreateOrUpdate($id = null)
    {
        ...
        return view('panel.user.frontend.generators_list.form', compact('item'));
    }
